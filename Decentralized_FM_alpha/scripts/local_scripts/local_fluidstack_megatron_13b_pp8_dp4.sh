...
MODEL_ARGS="--num-layers $num_layers --hidden-size 5120 --num-attention-heads 40 --micro-batch-size $MICRO_BATCH_SIZE --global-batch-size $global_batch_size --seq-length 2048 --max-position-embeddings 2048"
