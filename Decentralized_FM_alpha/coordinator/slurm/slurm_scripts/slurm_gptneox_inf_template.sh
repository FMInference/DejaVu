...
do
  ...
  INFERENCE_CONF="--fp16   --budget 10400 --batch-size 24 --input-seq-length 512 --generate-seq-length 32 --micro-batch-size 1 --num-layers 6 --max-layers 44 --infer-data ${infer_data}"
