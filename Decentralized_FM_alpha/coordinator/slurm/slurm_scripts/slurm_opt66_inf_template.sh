...
do
  ...
  MODEL_CONF="--model-type opt --model-name /sailhome/biyuan/fm/models/opt-66b-new --num-iters 9999999999999"
  INFERENCE_CONF="--fp16  --budget 20400 --batch-size 24 --input-seq-length 512 --generate-seq-length 32 --micro-batch-size 1 --num-layers 11 --max-layers 64 --infer-data $infer_data"
