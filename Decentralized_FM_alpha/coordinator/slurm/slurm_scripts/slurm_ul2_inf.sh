...
do
  ...
  MODEL_CONF="--model-type t5 --model-name /sailhome/biyuan/scratch/models/ul2-new --num-iters 10"
  INFERENCE_CONF="--budget 10600 --batch-size 24 --input-seq-length 512 --generate-seq-length 32 --micro-batch-size 1 --num-layers 2 --max-layers 32"
